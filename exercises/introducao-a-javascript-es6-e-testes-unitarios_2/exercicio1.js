...
const orderModifier = (order) => {
    const flavors = Object.keys (order.order.pizza).toString();
    return `Olá ${order.name}, o total do seu pedido de ${flavors} e ${order.order.drinks.coke.type} é R$ ${order.payment.total}.`;
